...
class PositionCriterion(nn.Module):
    def __init__(
        self,
    ...
    def forward(self, foreground_mask, targets, feature_strides, image_sizes):
        ...
        return {"loss_position": position_loss}
    ...
    def get_mask_single_level(self, coord_x, coord_y, gt_boxes, level_idx):
        ...
        # scale-independent position confidence
        ...
        confidence_per_box = (1 - torch.tanh(2 * math.pi * confidence - math.pi)) / 2
...
class PositionDETR(DNDETRDetector):
    def __init__(
        # model structure
        self,
        backbone: nn.Module,
